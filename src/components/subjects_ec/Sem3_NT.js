          ...
          <div class="card_sub">
            <div class="face_sub face1_sub">
              <div class="content_sub">
                ...
                <h3 class="h3_sub">
                  Time domain response of First order RL and RC circuit
                </h3>
              </div>
            </div>
            <div class="face_sub face2_sub">
          ...
          <div class="card_sub">
            <div class="face_sub face1_sub">
              <div class="content_sub">
                ...
                <h3 class="h3_sub">Initial conditions</h3>
              </div>
            </div>
            <div class="face_sub face2_sub">
              <div class="content_sub">
          ...
          <div class="card_sub">
            <div class="face_sub face1_sub">
              <div class="content_sub">
                ...
                <h3 class="h3_sub">Two –Port Networks</h3>
              </div>
            </div>
            <div class="face_sub face2_sub">
              <div class="content_sub">
          ...
          <div class="card_sub">
            <div class="face_sub face1_sub">
              <div class="content_sub">
                ...
                <h3 class="h3_sub">Introduction to Network Topology</h3>
              </div>
            </div>
            <div class="face_sub face2_sub">
              <div class="content_sub">
          ...
          <div class="card_sub">
            <div class="face_sub face1_sub">
              <div class="content_sub">
                ...
                <h3 class="h3_sub">
                  Introduction to Passive Network Synthesis
                </h3>
              </div>
            </div>
            <div class="face_sub face2_sub">
