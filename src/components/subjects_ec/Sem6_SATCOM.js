          ...
          <div class="card_sub">
            <div class="face_sub face1_sub">
              <div class="content_sub">
                ...
                <h3 class="h3_sub">Introduction to Satellite Communication</h3>
              </div>
            </div>
          ...
          <div class="card_sub">
            <div class="face_sub face1_sub">
              <div class="content_sub">
                ...
                <h3 class="h3_sub">Orbital Mechanics</h3>
              </div>
            </div>
            <div class="face_sub face2_sub">
              <div class="content_sub">
          ...
          <div class="card_sub">
            <div class="face_sub face1_sub">
              <div class="content_sub">
                ...
                <h3 class="h3_sub">Satellite sub-systems</h3>
              </div>
            </div>
            <div class="face_sub face2_sub">
              <div class="content_sub">
          ...
          <div class="card_sub">
            <div class="face_sub face1_sub">
              <div class="content_sub">
                ...
                <h3 class="h3_sub">Satellite link budget</h3>
              </div>
            </div>
            <div class="face_sub face2_sub">
              <div class="content_sub">
          ...
          <div class="card_sub">
            <div class="face_sub face1_sub">
              <div class="content_sub">
                ...
                <h3 class="h3_sub">Modulation and Multiple Access Schemes</h3>
              </div>
            </div>
            <div class="face_sub face2_sub">
              <div class="content_sub">
