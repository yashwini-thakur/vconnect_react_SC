          ...
          <div class="card_sub">
            <div class="face_sub face1_sub">
              <div class="content_sub">
                ...
                <h3 class="h3_sub">Fundamentals of Microprocessors</h3>
              </div>
            </div>
          ...
          <div class="card_sub">
            <div class="face_sub face1_sub">
              <div class="content_sub">
                ...
                <h3 class="h3_sub">AVR Assembly and C Programming</h3>
              </div>
            </div>
            <div class="face_sub face2_sub">
              <div class="content_sub">
          ...
          <div class="card_sub">
            <div class="face_sub face1_sub">
              <div class="content_sub">
                ...
                <h3 class="h3_sub">Device interfacing and its programming</h3>
              </div>
            </div>
            <div class="face_sub face2_sub">
              <div class="content_sub">
